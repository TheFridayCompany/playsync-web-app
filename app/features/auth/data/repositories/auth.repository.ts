...
export default class AuthRepository implements IAuthRepository {
  ...
  private checkIfMobile() {
    if (typeof navigator === "undefined") return false; // Ensure it runs only on client-side
  ...
  async signInWithGoogle(): Promise<AuthUser | null> {
    ...
    if (isMobile) {
      return this.authGateway.signInWithGoogleWithRedirect();
    }

    return this.authGateway.signInWithGoogleWithPopup();
  }
